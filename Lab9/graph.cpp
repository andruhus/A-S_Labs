...
Vertex::Vertex(Worker& d) :data(d) {
}

Worker& Vertex::getData() {
    return  data;
}
...
//************************* ������ ������ AdjecentListBasedGraph *************************

AdjecentListBasedGraph::AdjecentListBasedGraph(string file, vector<Worker>& dataVector) {
...
Graph::Graph(string file, vector<Worker>& dataVector) :graphData(file, dataVector) {
}
