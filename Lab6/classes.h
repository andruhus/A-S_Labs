    ...
    while (!end)
    {
        ...
        if (current_node->parent_)
        {
            if (current_node->parent_->colour_)
                std::cout << red << current_node->parent_->value_ << white;
        ...
        if (position == 1)
        {
            if (current_node->left_)
                if (current_node->left_->colour_)
                    std::cout << red << "-> Left Node " << current_node->left_->value_ << std::endl << white;
        ...
        if (position == 2)
        {
            if (current_node->right_)
                if (current_node->right_->colour_)
                    std::cout << red << "-> Right Node " << current_node->right_->value_ << std::endl << white;
